class Vector:
    ...
    def __init__(self, d):
        """Create d-dimensional vector of zeros or
         of certain dimentional coordinates"""
        try:
            if int(d):
                self._coords = [0]*d
        except:
    ...
    def __neg__(self):
        """Return new Vector instance whose coordinates are
         all negated values of the original ones"""
    ...
    def __radd__(self, other):
        """Returns Vectors sum with other coordinates of
         object with same dimentions"""
        return self.__add__(other)

    def __mul__(self, other):
        """Return new Vector instance whose coordinates are
         x(other) times of the original"""
